...
,
					"patching_rect" : [ 839.5, 449.0, 55.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 564.0, 345.0, 50.5, 22.0 ],
					"text" : "gate 4"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 757.5, 493.0, 50.0, 22.0 ]
				}
...
,
					"patching_rect" : [ 757.5, 449.0, 73.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 405.0, 316.0, 82.0, 24.0 ],
					"suppressinlet" : 1,
					"text" : "output 4",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 510.0, 297.0, 94.0, 24.0 ],
					"suppressinlet" : 1,
					"text" : "tap tempo",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 404.0, 281.0, 83.0, 24.0 ],
					"suppressinlet" : 1,
					"text" : "slide",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 510.0, 266.0, 100.0, 24.0 ],
					"suppressinlet" : 1,
					"text" : "add-subtract",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 404.0, 248.0, 83.0, 24.0 ],
					"suppressinlet" : 1,
					"text" : "no output",
					"textjustification" : 1,
					"underline" : 1
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 489.0, 252.0, 19.0, 82.0 ],
					"shape" : 1,
					"size" : 5,
					"value" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 489.0, 345.0, 50.5, 22.0 ],
					"text" : "gate 4"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 477.5, 510.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 254.0, 244.0, 49.0, 22.0 ],
					"text" : "noteout"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 290.0, 119.0, 336.0, 53.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 790.0, 624.0, 749.796875, 624.0, 749.796875, 408.0, 705.5, 408.0 ],
					"source" : [ "obj-102", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 616.5, 176.5, 196.5, 176.5 ],
					"source" : [ "obj-2", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 299.5, 176.5, 181.5, 176.5 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 1 ],
					"midpoints" : [ 196.5, 223.5, 278.5, 223.5 ],
					"source" : [ "obj-23", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 181.5, 223.5, 263.5, 223.5 ],
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 493.5, 211.0, 530.0, 211.0 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 517.166666666666629, 211.0, 605.0, 211.0 ],
					"source" : [ "obj-27", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 519.5, 382.1484375, 767.0, 382.1484375 ],
					"source" : [ "obj-42", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-64", 0 ],
					"midpoints" : [ 594.5, 408.0, 767.0, 408.0 ],
					"source" : [ "obj-93", 2 ]
				}
